        ...
        while(pc<qTable.NextQuad())
        {
            ...
            if(holdQuad[0] >= 0 && holdQuad[0] < maxOpcode) //verify valid opcode
            {
                ...
                else if(holdQuad[0] == 6)//PRINT
                {
                    ...
                    if(type == 'I')
                    {
                        System.out.println(sTable.GetSymbol(holdQuad[3]) + " " + sTable.GetInteger(holdQuad[3]));
                    }
                    else if(type == 'F')
                    {
                        System.out.println(sTable.GetSymbol(holdQuad[3]) + " " + sTable.GetFloat(holdQuad[3]));
                    }
                    else
                    {
                        System.out.println(sTable.GetSymbol(holdQuad[3]) + " " + sTable.GetString(holdQuad[3]));
                    }
                    pc++;
                }
