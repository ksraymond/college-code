...
//
//Problem Statement:
//perform a series of turns using 2 wheel turns
//
//
//              ^^^^ Algorithm ^^^^
//
...
//        spin the left wheel forward and the right wheel backwards to turn right
//        forward then right again
//        forward
//        spin right wheel forward and the left wheel backwards to turn left
//        forward
//
