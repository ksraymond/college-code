...
namespace Challenge7_RPGUI
{
    public class Mage : Sprites
    {
        ...
        string name = "Mage";
        Image spriteImage = Properties.Resources.Mage;
        ...
        public override void SetMoves()
        {
            ...
            moveSet[1] = new Moves("Fireball", strength + skillPoints, "Throw a fireball at the opposing enemy dealing magic damage");
            moveSet[2] = new Moves("Sludge", Intelligence + skillPoints, "Throw a sludge ball at the opposing enemy dealing magic damage");
        }
    }
}